...
- Change HTML5 video speed with the popup or page shortcuts: `G` toggles 1× / 1.5×, `D` adds 0.25×, and `S` subtracts 0.25×. A subtle badge at the video's top-left stays in sync with the current rate as the player moves between videos.
